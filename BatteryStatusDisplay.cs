...
namespace BatteryManagement
{
    public class BatteryStatusDisplay
    {
        ...
        public static void PrintMinimumWarning(string BatteryState, float MinBatteryWarning, float BatteryValue)
        {
            if (BatteryCheckerFactors.GermanLanguage)
        ...
        public static void PrintMaximumWarning(string BatteryState, float MaxBatteryWarning, float BatteryValue)
        {
            if (BatteryCheckerFactors.GermanLanguage)
